...
namespace psai.net
{
    ...
    public class Segment
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append(")");
            sb.Append(" ");
            sb.Append(getStringOfSegmentTypes(this.SnippetTypeBitfield));
            sb.Append(" [");
        ...
        {            
            ...
            for (int i = 0; i < argSnippets.Count; i++)
            {
                ...
                if (snippet != this)
                {
                    float diff = Math.Abs(snippet.Intensity - this.Intensity);
        ...
        public static string getStringOfSegmentTypes(int snippetTypeBitfield)
        {           
