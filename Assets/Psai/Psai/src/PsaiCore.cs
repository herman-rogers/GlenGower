...
namespace psai.net
{
    ...
    public class PsaiCore
    {
        ...
        /// <remarks>The PsaiCore class provides this Singleton for conveniece, so you can easily access your psai soundtrack from all classes.</remarks>
        /// </summary>
        ...
        /// <returns>PsaiResult.OK if successful</returns>
        public bool SetLogLevel(LogLevel newLogLevel)
	    {
		    return m_logik.setLogLevel(newLogLevel);
	    }
        ...
        /// <summary>
        /// Ends the current Theme and returns to the most recently triggered Basic Mood.
        /// </summary>
        /// <remarks>
        ...
        {
            return m_logik.m_soundtrack.getSnippetInfo(segmentId);
        }
