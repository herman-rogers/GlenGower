...
public class PsaiMultiAudioObjectEditor : EditorWindow
{
    ...
    static readonly AudioClipLoadType PSAI_DEFAULT_LOADTYPE = AudioClipLoadType.Streaming;
    ...
    void OnGUI()
    {
        ...
        _createWrapperPrefabs = EditorGUILayout.Toggle("create Wrappers", _createWrapperPrefabs);
