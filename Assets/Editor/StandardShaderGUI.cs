...
internal class StandardShaderGUI : ShaderGUI
{
	...
	void DoEmissionArea(Material material)
	{
		...
		if (showEmissionColorAndGIControls && lightmapping != null)
		{
			...
			m_MaterialEditor.ShaderProperty(lightmapping, lightmapping.displayName, MaterialEditor.kMiniTextureFieldLabelIndentLevel + 1);
