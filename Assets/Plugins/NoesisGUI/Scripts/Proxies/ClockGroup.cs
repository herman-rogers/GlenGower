...
public class ClockGroup : Clock {
  ...
  internal ClockGroup(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.ClockGroup_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  public Clock GetChild(uint index) {
    ...
    if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
    #endif
    return Noesis.Extend.GetProxy(cPtr, false) as Clock;
  }
