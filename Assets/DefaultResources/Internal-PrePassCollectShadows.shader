...
// either for later blurring or with PCF filtering while collecting.
...
// Subshader for hard shadows or screenspace blur:
// Just collect shadows into the buffer.
SubShader {
	Pass {
...
// Subshader that does PCF 5x5 filtering
// while collecting shadows.
Subshader {
